...
func (app *App) setMainMenu(foundation.Notification) {
	...
	mainMenu := appkit.NewMenuWithTitle("App")
	mainMenu.AddItem(appkit.NewMenuItemWithAction("Hide Proxies", "h", func(_ objc.Object) { app.Hide(nil) }))
	mainMenu.AddItem(appkit.NewMenuItemWithAction("Quit Proxies", "q", func(_ objc.Object) { app.Terminate(nil) }))
